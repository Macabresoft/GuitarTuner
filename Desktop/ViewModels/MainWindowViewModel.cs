...
public class MainWindowViewModel : BaseDialogViewModel {
    ...
    public float DistanceFromBase {
        ...
        set => this.RaiseAndSetIfChanged(ref this._distanceFromBase, value);
    }
    ...
    private MicrophoneListener CreateListener() {
        return new MicrophoneListener(ALFormat.Mono16, (int)Math.Ceiling(SampleRate / this.SelectedTuning.MinimumFrequency) * 2);
    }
